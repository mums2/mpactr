...
mpactr requires 2 files as imput: a feature table and metadata file.
...
This results in 4686 ions in the feature table (above). Even though we
created an object called `data2_mispicked`, the original `data2` object
was also updated and now has 4686 ions in the feature table:
...
#> ✔ 2179 ions failed the cv_filter filter, 2777 ions remain.
```

In our example dataset, 2179 ions were flagged as non-reproducible.
These ions were removed, leaving 2777 ions in the feature table.
...
index_scale:
    ...
    #> 6 1.96_293.6773m/z  0.0104      5      0.101
...
![](filter2_files/figure-html/unnamed-chunk-20-1.png)

Here we can see that roughly 56% of features were below the CV threshold
meaning 44% were removed at a CV threshold of 0.2.
...
#> ℹ Argument remove_ions is: TRUE.Removing peaks from Media.
#> ✔ 1239 ions failed the Media filter, 563 ions remain.
```
...
![](filter2_files/figure-html/unnamed-chunk-31-1.png)
...
![](filter2_files/figure-html/unnamed-chunk-32-1.png)
...
![](filter2_files/figure-html/unnamed-chunk-33-1.png)
...
![](filter2_files/figure-html/unnamed-chunk-34-1.png)
