# mpactr 0.3.3
* Minor naming inconsistencies inside the package. All imported peak_tables names that are not in the `injection` column of the metadata file will be lowercased.
# mpactr 0.3.2
