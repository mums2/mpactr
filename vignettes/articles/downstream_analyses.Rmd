...
We can plot log2 fold change values against log~10~ p-values or log~10~ q-values, both of which we calcuated in our t-tests above.
...
fc2 %>%
  mutate(
    ...
    sig = factor(sig,
      ...
      labels = c("Increased", "Decreased", "Inconclusive", "Not sigificant")
    )
  ) %>%
