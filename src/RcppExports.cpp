...
RcppExport SEXP _mpactr_RemoveDuplicates(SEXP compoundNamesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::StringVector& >::type compoundNames(compoundNamesSEXP);
    rcpp_result_gen = Rcpp::wrap(RemoveDuplicates(compoundNames));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_mpactr_RemoveDuplicates", (DL_FUNC) &_mpactr_RemoveDuplicates, 1},
    {NULL, NULL, 0}
};
