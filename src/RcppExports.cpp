...
// FilterCV
Rcpp::DataFrame FilterCV(const Rcpp::DataFrame& peakTable, const std::vector<std::string>& uniqueSampleList, const size_t replicates, const bool fixPeaks);
RcppExport SEXP _mpactr_FilterCV(SEXP peakTableSEXP, SEXP uniqueSampleListSEXP, SEXP replicatesSEXP, SEXP fixPeaksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::DataFrame& >::type peakTable(peakTableSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(FilterCV(peakTable, uniqueSampleList, replicates, fixPeaks));
    return rcpp_result_gen;
END_RCPP
}
// UniqueDuplicates
