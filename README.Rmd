...
All filters are independent, meaning they can be used to create a project-specific workflow, or you can learn more in [the Filter vignette](https://www.schlosslab.org/mpactr/articles/filter2.html).
...
See [the Filter vignette](https://www.schlosslab.org/mpactr/articles/filter2.html) to get started.
